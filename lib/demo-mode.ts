...
import memberBusinessesData from '@/data/mock/directory.json'
...
const mockDataMap: Record<string, any> = {
  ...
  'directory.json': memberBusinessesData,
...
export function handleMockQuery(body: string): any {
  try {
    ...
    if (query.includes('GetMemberBusinesses') || query.includes('nodeMemberBusinesses')) {
      return loadMockData('directory.json')
    }
