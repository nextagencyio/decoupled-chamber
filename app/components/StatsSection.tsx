...
const defaultStats = [
  { id: 'stat-1', value: '650+', label: 'Member Businesses' },
  { id: 'stat-2', value: '75+', label: 'Annual Events' },
  { id: 'stat-3', value: '95%', label: 'Member Retention' },
  { id: 'stat-4', value: '96', label: 'Years Serving Lakewood' },
]
