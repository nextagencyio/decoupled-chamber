...
const navigationItems = [
  { name: 'Home', href: '/' },
  { name: 'Member Businesses', href: '/directory' },
        ...
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center space-x-3 hover:opacity-90 transition-opacity duration-200">
            ...
            <div className="hidden sm:block">
              <span className="text-lg font-bold text-white leading-tight font-display">Lakewood Chamber</span>
              <span className="block text-xs text-primary-300 font-medium -mt-0.5">of Commerce</span>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-3">
            <a href="tel:555-901-2345" className="hidden md:flex items-center text-primary-200 hover:text-white text-sm transition-colors">
              <Phone className="w-4 h-4 mr-1.5" />(555) 901-2345
            </a>
