...
export default function CTASection({ homepageContent }: CTASectionProps) {
  const title = (homepageContent as any)?.ctaTitle || 'Ready to Grow Your Business?'
  const description = (homepageContent as any)?.ctaDescription?.processed || ''
  const primaryLabel = (homepageContent as any)?.ctaPrimary || 'Become a Member'
    ...
    <section className="bg-primary-800 py-16 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {description ? (
          ...
          <p className="text-primary-100 mb-8 max-w-2xl mx-auto text-lg">Join 650+ businesses that rely on the Lakewood Chamber for networking, advocacy, and growth resources.</p>
        )}
